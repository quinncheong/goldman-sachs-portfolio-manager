          ...
          <div className="form-control w-full max-w-xs">
            ...
            <label className="input-group">
              <input
                type="number"
                placeholder="0.00"
                className="input input-bordered [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                value={inputValue}
            ...
            {showWarning && (
              <label className="label">
                <span className="label-text-alt text-error">
                  Amount of capital cannot exceed cash balance
                </span>
              </label>
            )}
          </div>
